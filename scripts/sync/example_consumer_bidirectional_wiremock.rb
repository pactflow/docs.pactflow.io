...
SOURCE_REPO = 'pactflow/example-bi-directional-consumer-wiremock'
DESTINATION_DIR = relative_path_to('website/docs/docs/examples/bi-directional/consumer/wiremock')
