...
SOURCE_REPO = 'pactflow/example-bi-directional-consumer-dotnet'.freeze
DESTINATION_DIR = relative_path_to('website/docs/docs/examples/bi-directional/consumer/dotnet')
