...
SOURCE_REPO = 'pactflow/example-provider-java-kafka'
DESTINATION_DIR = relative_path_to('website/docs/docs/examples/kafka/java/')
TRANSFORM_PATH = -> (path) { File.join(DESTINATION_DIR, "provider.md") }
INCLUDE = [
