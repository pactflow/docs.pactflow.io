...
SOURCE_REPO = 'pactflow/example-bi-directional-provider-dotnet'.freeze
DESTINATION_DIR = relative_path_to('website/docs/docs/examples/bi-directional/provider/dotnet')
