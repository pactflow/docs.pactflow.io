...
SOURCE_REPO = 'pactflow/example-bi-directional-consumer-mountebank'.freeze
DESTINATION_DIR = relative_path_to('website/docs/docs/examples/bi-directional/consumer/mountebank')
