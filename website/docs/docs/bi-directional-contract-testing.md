...
| Internal microservices following a contract-first approach (OpenAPI Specification) | Contract testing is ideally suited to internal service-to-service testing                                                                                                                                                                                                                                    | Bi-Directional Contract Testing can speed this process up by re-using the OAS as the provider contract                                                                                              |
...
| **Summary**     | The highest cost and maintenance, with the best guarantees | Strongest contract-testing outcomes but comes with a learning curve.                                                                                                                                                                                 | Weaker guarantees than CDC but decouples teams and can be used with third parties/unknown consumers.                                                                                                                                                                                                                                                                                                                                                              |
