...
* Display [Pact V4 bodies](https://github.com/pact-foundation/pact-specification/tree/version-4#bodies) details in the UI instead of treating the section as a JSON.
