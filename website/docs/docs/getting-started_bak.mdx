...
import {
  ...
  languageIcons
} from "../../src/components/svgGenerator";
...
<div>
    {languageIcons.icon_javascript}
    {languageIcons.icon_java}
    {languageIcons.icon_golang}
    {languageIcons.icon_ruby}
    {languageIcons.icon_dotnet}
    {languageIcons.icon_docker}
    {languageIcons.icon_kotlin}
    {languageIcons.icon_scala}
    {languageIcons.icon_clojure}
    {languageIcons.icon_python}
    {languageIcons.icon_swift}
    {languageIcons.icon_php}
    {languageIcons.icon_cplusplus}
</div>
...
<TabItem value="js" label={<a href="https://docs.pact.io/implementation_guides/javascript"><img src="https://raw.githubusercontent.com/pact-foundation/pact.io/master/pages/assets/img/languages/javascript-original.svg" alt="foo" /> JavaScript</a>} >
...
<TabItem value="dotnetcsharp" label=".NET">
...
<Tabs groupId="languages">
 ...
 <TabItem value="js" label={
   generateIconWithLabel('JavaScript',
...
<TabItem value="java" label={
   generateIconWithLabel('Java',
...
<TabItem value="golang" label={
   generateIconWithLabel('Golang',
