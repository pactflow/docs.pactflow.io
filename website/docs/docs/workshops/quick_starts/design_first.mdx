...
1. Create OpenAPI Document in SwaggerHub
   ...
   8. Select `Create API`
   9. Paste the contents of TODO ADD LINK TO OAS SPEC
...
1. Fork the [example-provider](example-provider) projects in to your own Github account (click the 'Fork' button in the top right).
...
1. Fork the [example-consumer][example-consumer] project in to your own Github account (click the 'Fork' button in the top right).
