...
If you want a recap on the [agenda](docs/workshops/bi-directional-contract-testing#agenda), otherwise see the table of contents and lets get stuck in.
:::
...
- [Create a Github Secret to store your Pactflow Base url in.](#create-a-github-secret-to-store-your-pactflow-base-url-in)
...
- our other [workshops](https://docs.pact.io/implementation_guides/workshops), or
- getting deeper into [BDCT](docs/bi-directional-contract-testing)
- a dive into our [CI/CD](https://docs.pactflow.io/docs/workshops/ci-cd/) workshop with Pact and the consumer driven contract testing approach.
  :::
