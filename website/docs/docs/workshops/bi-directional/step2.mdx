...
2. Clone the repository on to your local machine.
    ...
    ```bash
    git clone git@github.com:<YOUR_GITHUB_USERNAME>/example-bi-directional-provider-dreddr.git
    ```
...
[example-bi-directional-provider-dredd]: https://github.com/pactflow/example-bi-directional-provider-dredd
...
1. `cd /root/example-bi-directional-provider-dredd`
1. `curl localhost:3000/products | jq .`
