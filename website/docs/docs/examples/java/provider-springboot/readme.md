...
* In [.travis.yml](https://raw.githubusercontent.com/pactflow/example-provider-springboot/master/.travis.yml)
...
* In the [Makefile](https://raw.githubusercontent.com/pactflow/example-provider-springboot/master/Makefile):
...
* In [src/product/product.pact.test.js](https://raw.githubusercontent.com/pactflow/example-provider-springboot/master/src/product/product.pact.test.js):
