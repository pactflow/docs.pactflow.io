---
custom_edit_url: https://github.com/pactflow/example-bi-directional-provider-postman/edit/master/README.md
title: Example NodeJS Provider - Postman
sidebar_label: Example NodeJS Provider - Postman
---

<!-- This file has been synced from the pactflow/example-bi-directional-provider-postman repository. Please do not edit it directly. The URL of the source file can be found in the custom_edit_url value above -->
...
![Provider Test](https://raw.githubusercontent.com/pactflow/example-bi-directional-provider-postman/master/docs/provider-scope.png)
...
![Provider Pipeline](https://raw.githubusercontent.com/pactflow/example-bi-directional-provider-postman/master/docs/provider-pipeline.png)
