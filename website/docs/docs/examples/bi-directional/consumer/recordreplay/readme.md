---
custom_edit_url: https://github.com/pactflow/example-bi-directional-consumer-nock/edit/master/README.md
title: Example NodeJS/React Consumer - Nock (BYO Adapter)
sidebar_label: Example NodeJS/React Consumer - Nock (BYO Adapter)
---

<!-- This file has been synced from the pactflow/example-bi-directional-consumer-nock repository. Please do not edit it directly. The URL of the source file can be found in the custom_edit_url value above -->
...
![Consumer Pipeline](https://raw.githubusercontent.com/pactflow/example-bi-directional-consumer-nock/master/docs./../docs/consumer-pipeline.png)
