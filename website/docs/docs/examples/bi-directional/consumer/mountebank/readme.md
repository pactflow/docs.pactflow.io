...
title: Example NodeJS Consumer - Mountebank (BYO Adapter)
sidebar_label: Example NodeJS Consumer - Mountebank (BYO Adapter)
---
...
![Consumer Test](https://raw.githubusercontent.com/pactflow/example-bi-directional-consumer-mountebank/master/docs/consumer-scope.png)
