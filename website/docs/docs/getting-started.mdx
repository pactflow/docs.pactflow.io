...
We also have a Slack workspace where you can chat with other members and get general support with the contract testing or the product. Join us by registering [here](http://slack.pact.io/).
