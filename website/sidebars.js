  ...
  docs: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: ["docs/authentication/main", "docs/authentication/legacy"],
        },
        {
          type: "category",
          label: "SCIM",
          items: ["docs/scim/main", "docs/scim/okta"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "docs/login-help",
        `docs/authorization-help`,
        "docs/webhooks-help",
        "docs/powershell-guide",
        "docs/troubleshooting/disabling-dangerous-contract-modification",
        "docs/troubleshooting/slow-response-when-fetching-pacts-for-verification",
        "docs/troubleshooting/apihub",
      ],
    },
    {
      type: "link",
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'docs/on-premises/releases/1.36.1',
